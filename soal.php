...
<head>
    ...
    <title>Ujian Online E-Learning SKL</title>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div id="konfirm" style="display:none; margin-top:15px;">
                                Apakah Anda yakin sudah selesai mengerjakan soal dan akan mengirim jawaban? &nbsp; <input name="simpaan" onclick="selesai();" type="submit" id="kirim" value="Ya" class="btn btn-info btn-sm" />
                            </div>
                            <script type="text/javascript">
